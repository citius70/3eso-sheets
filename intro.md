...
Ahora que tienes una idea general, me gustaría saber qué has captado:

**Actividad de Aprendizaje (Cuestionario rápido):**

Si tuvieras que explicarle a un compañero de clase para qué sirve Google Sheets, ¿cuál de estas opciones escogerías?

A) Principalmente para escribir cartas y hacer redacciones largas.  
B) Para crear presentaciones visuales y diapositivas bonitas.  
C) Para organizar información en tablas y hacer cálculos automáticos.  

¡Dime cuál crees que es la respuesta correcta! 🧐