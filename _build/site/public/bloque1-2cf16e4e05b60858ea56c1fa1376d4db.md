...
La **lógica condicional** se gestiona mediante la **Referencia Absoluta** (`$`) para fijar valores (ej. un **Extra de 0,5** o el **IVA del 21,00%**), y la **Función SI (IF)**, que **automatiza decisiones** (ej. mostrar **Aprobado** o **Suspenso**). El **Formato Condicional** aplica estilos automáticamente (ej. notas $\ge 5$ en verde).
