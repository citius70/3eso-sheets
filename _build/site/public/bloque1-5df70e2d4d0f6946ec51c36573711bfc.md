...
* La **Columna** es una caja vertical que contiene el mismo tipo de dato para todos los objetos (por ejemplo, todas las notas de Matemáticas). El **Formato** es la etiqueta de color o el tipo de letra que se usa para que la información sea fácil de encontrar y entender.
